      ...
      <div className="auth-container">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <button type="submit" className="btn btn-primary" disabled={loading}>
              {loading ? (
                ...
                <span className="btn-content"><LogIn size={18} /> লগইন</span>
              )}
            </button>
          </form>
        ...
        <div className="auth-branding">
          <div className="branding-content">
            ...
            <p>স্মার্ট CV পার্সিং, AI ম্যাচ স্কোরিং, এবং সম্পূর্ণ হায়ারিং পাইপলাইন — সব এক প্ল্যাটফর্মে।</p>
            <div className="branding-features">
              <div className="feature-pill">🎯 AI Match Scoring</div>
              <div className="feature-pill">📄 Smart CV Parsing</div>
              <div className="feature-pill">📊 Analytics Dashboard</div>
              <div className="feature-pill">🔒 Role-Based Access</div>
            </div>
          </div>
        </div>
      </div>
